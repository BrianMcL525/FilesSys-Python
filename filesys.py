...
Program: filesys.py
Author: Brian
Provides a menu-driven tool for vaigating a file system and gathering information on files.
"""
import os, os.path
...
def acceptCommand():
    """Inputs and returns a legitimante command number."""
    command = input("Enter a number:")
    if command in COMMANDS:
        return command
    else:
        print("ErrorL command not recognized")
...
def moveUp():
    """Moves up to the parent directory. unles the cwd is the root"""
    os.chdir("..")
